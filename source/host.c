...
void Host_Init (quakeparms_t *parms)
{
	...
	switch(psp_system_model) {
		case PSP_MODEL_PHAT: Con_Printf("PSP-1000 model unit\n"); break;
		case PSP_MODEL_SLIM: Con_Printf("PSP-SLIM model unit\n"); break;
		case PSP_MODEL_PSVITA: Con_Printf("PS VITA model unit\n"); break;
		default: break;
	}

	// Cypress TODO: Clean this up
